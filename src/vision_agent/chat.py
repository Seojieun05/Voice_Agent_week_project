...
QUESTION_GUIDANCE: Mapping[str, str] = {
    ...
    "can_i_go": (
        ...
        "기본 답은 '네'입니다. 다음 특별한 문제가 있을 때만 '아니요'라고 합니다: "
        "전방(중앙 또는 전방 전체)에 distance가 '가까움'인 사람·물체·장애물이 있음, "
        "사람이 아주 많음, 차·오토바이·자전거·킥보드가 빠르게 다가오고 있음, "
        "인도가 아니거나 진행할 길이 없음. "
        "distance가 '중간'이나 '멀리'인 물체, 왼쪽/오른쪽에만 있는 물체는 '아니요'의 근거가 "
        "아닙니다. '네'라고 답할 때 주의할 물체가 있으면 '다만 ~에 있는 ~는 주의하세요'를 "
        "덧붙입니다. "
